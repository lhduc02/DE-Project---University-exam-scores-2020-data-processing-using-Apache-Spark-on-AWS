...
1. Tạo cụm Spark với các Node là các máy ảo EC2 để xử lý tập dữ liệu trên.

2. Dữ liệu sạch được lưu trữ trong Amazon RDS for MySQL và file .csv để phục vụ cho việc trực quan hóa và phân tích dữ liệu.
